...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        {{-- Kartu Aktivitas - Berubah sesuai tanggal yang dipilih --}}
        ...
        {{-- Kartu Riwayat - Daftar dokumen sesuai tanggal yang dipilih --}}
                ...
                @forelse($riwayatHariIni as $item)
                    <div class="mb-2 p-2 bg-gray-700/30 rounded border border-gray-600 flex justify-between items-center group">
                        <div class="truncate mr-2 flex flex-col">
                            <span class="text-white font-bold text-[11px] truncate flex items-center">
                        ...
                        <div class="flex items-center space-x-2">
                            {{-- Tombol Tracking Statis untuk Presentasi --}}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(dateInput) {
        dateInput.addEventListener('change', function() {
            ...
            if(date) {
                // Efek loading saat berpindah tanggal
                document.body.style.opacity = '0.5';
                // Mengarahkan ke route dashboard dengan parameter tanggal
