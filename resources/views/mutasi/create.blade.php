...
<div class="container mx-auto max-w-3xl">
    <div class="bg-gray-800 rounded-lg shadow-xl border border-gray-700">
        <div class="p-6 border-b border-gray-700 flex justify-between items-center">
            <h2 class="text-xl font-bold text-white">Tambah Data Mutasi</h2>
        ...
        <form action="{{ route('mutasi.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                ...
                <select name="jenis_mutasi" class="w-full p-3 rounded bg-gray-700 border border-gray-600 text-white focus:border-red-600 outline-none">
                    ...
                    @foreach(['Kenaikan Pangkat', 'Masuk', 'Pindah Antar Instansi', 'Keluar'] as $jenis)
                        <option value="{{ $jenis }}" {{ old('jenis_mutasi') == $jenis ? 'selected' : '' }}>
                            {{ $jenis }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="no_sk" value="{{ old('no_sk') }}" placeholder="Masukkan Nomor SK"
                           class="w-full p-3 rounded bg-gray-700 border border-gray-600 text-white focus:border-red-600 outline-none">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="instansi_tujuan" value="{{ old('instansi_tujuan') }}" placeholder="Nama Instansi Tujuan"
                       class="w-full p-3 rounded bg-gray-700 border border-gray-600 text-white focus:border-red-600 outline-none">
            </div>
